    ...
    private void cuentaHabitantes() throws NoSuchAlgorithmException {
        ...
        for(int i = 0; i < 100; i++) {
            try {
                ...
                vivienda = null;
                // TODO: Añadir al habitante una vivienda desde la base de datos (crearla y hacer un findOne)
